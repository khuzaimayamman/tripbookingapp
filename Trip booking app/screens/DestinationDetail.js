                ...
                >
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <View style={{ marginHorizontal: SIZES.radius, justifyContent: 'space-around' }}>
                            <Text style={{ ...FONTS.h3 }}>Babusar Top</Text>
                            <Text style={{ color: COLORS.gray, ...FONTS.body3 }}>Gilgit</Text>
                    ...
                    <View style={{ marginTop: SIZES.radius }}>
                        ...
                        Babusar Top appartment offers simple rooms with mountain views in front of the ski lift to the Ski Resort
                        </Text>
                    </View>
                </View>
                ...
                >
                    <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                        <View style={{ flex: 1, marginHorizontal: SIZES.padding, justifyContent: 'center' }}>
                            <Text style={{ ...FONTS.h1 }}>Rs10000</Text>
                        </View>
